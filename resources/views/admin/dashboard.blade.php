...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Chasoul VS Code </a>
  ...
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel">Activity Chart Management</h5>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Activity Chart Management</h1>
        <h2></h2>
      ...
      <canvas class="my-4 w-100" id="myChart" width="500" height="150"></canvas>
      {{-- <h2 style="text-align: center">Data Student</h2> --}}
      <p style="margin-bottom: -30px">Data Student</p>
        ...
        <body>
          <div class="container">
            ...
            <div class="container mt-5">
              <button type="button" class="btn btn-dark-blue" data-toggle="modal" data-target="#tambahModal">Add New Data</button>
              <br><br>
...
<div class="container mt-0">
  <!-- Edit Button -->
  <a href="#" onclick="ModalEdit({{ $Get->npm }}, '{{ $Get->name }}', '{{ $Get->prodi }}', '{{ $Get->semester }}', '{{ $Get->kelas }}')">
      <i class="fas fa-edit"></i>Update
  </a>

  <!-- Edit Modal -->
  <form action="{{ route('admin.dashboard.edit') }}" method="post">
      @csrf
...
<script>
  function ModalEdit(npm, name, prodi, semester, kelas) {
      $('[name="npm"]').val(npm);
      $('[name="name"]').val(name);
...
{{-- Delete / Hapus --}}
                      <form action="{{ url('admin/dashboard/hapus') }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this record?');">
                        @csrf
                        <input type="hidden" name="npm" value="{{ $Get->npm }}">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <form action="admin/dashboard/hapus" method="post">
      @csrf
